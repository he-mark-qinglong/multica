"""Run V8: vpvr_regime_reversion_4h_vol_switch_20260710 (iter 72) — per symbol, with buy-hold baseline."""
    ...
    return [
        {
            ...
            "rv_bps_at_entry": t.rv_bps_at_entry,
        }
...
def main() -> int:
    ...
    print(f"\n=== V8 vpvr_regime_reversion_4h_vol_switch_20260710 iter={cfg['iteration']} axis=vol_regime ===")
