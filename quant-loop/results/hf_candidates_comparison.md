...
> Focus: 1m / 5m timeframe strategies. Generated from results-ledger.md + loid_iceberg_v4 scan analysis.

## Summary

- Total HF strategies evaluated: 24
- PASS: 0
- HOLD: 1 (mtf_xs_pairs H3 — proven multi-TF template)
- KILL: 16 (15 graveyard + loid_iceberg_v4)
- UNTESTED: 7
...
|----------|----|--------|------------------|-----------|-----------|------------|----|-------|--------|---------|
| `loid_iceberg_v4_1m_20260720` | 1m | ACTIVE | 2.468* | — | — | — | 1.49 | -130.830 | 59268 | **KILL** |
| `mtf_h2_vpvr_edge_1m_15m_2h_20260718` | 1m | ACTIVE | — | — | — | — | — | — | — | UNTESTED |
| `mtf_vpvr_edge_zscore_1m_15m_2h_20260718` | 1m | ACTIVE | — | — | — | — | — | — | — | UNTESTED |
| `mtf_xs_pairs_1m_15m_2h_h1_20260718` | 1m | ACTIVE | — | — | — | — | — | — | — | UNTESTED |
| `mtf_xs_pairs_1m_15m_2h_h2_20260718` | 1m | ACTIVE | — | — | — | — | — | — | — | UNTESTED |
| `mtf_xs_pairs_1m_15m_2h_h3_20260718` | 1m | ACTIVE | — | — | — | — | — | — | — | HOLD |
| `mtf_xs_pairs_1m_15m_2h_h4_20260718` | 1m | ACTIVE | — | — | — | — | — | — | — | UNTESTED |
...
| `vpvr_reversion_5m_vwap_trail_20260709` | 5m | ACTIVE | — | — | — | -9.621 | — | -0.016 | 6536 | KILL |
...
*loid_iceberg_v4 Sharpe 2.468 is misleading — equity went negative (-130.8% maxDD), making daily-resampled Sharpe an artifact of negative returns. All 15 parameter combinations showed -100% annualized return.
...
2. **mtf_xs_pairs H3 is the only positive-expectation HF candidate**: Multi-timeframe (1m entry + 15m sizing + 2h regime) is the proven template. OOS Sharpe 2.77, ann 59.8%, CI lower 1.914.
3. **loid_iceberg_v4 KILL confirmed**: 15 parameter combinations tested, all lose 100% of capital. T01/T04 cost-cap pattern extends to iceberg/large-order signals. Only revival path is sub-taker execution (T10).
...
- Any new HF proposal must declare novel-prior vs T01/T04/T09 kills and satisfy cycle-46 (asymmetric execution OR multi-TF confirmation).
