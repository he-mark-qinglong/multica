"""Run V6: vpvr_micro_reversion_1h_funding_filter_20260710 (iter 70) — per symbol, with buy-hold baseline."""
...
def main() -> int:
    ...
    for sym, df in data.items():
        ...
        # Required by display engine: trades_A_<tf>_<SYM>.csv
    ...
    print(f"\n=== V6 vpvr_micro_reversion_1h_funding_filter_20260710 iter={cfg['iteration']} axis=microstructure ===")
