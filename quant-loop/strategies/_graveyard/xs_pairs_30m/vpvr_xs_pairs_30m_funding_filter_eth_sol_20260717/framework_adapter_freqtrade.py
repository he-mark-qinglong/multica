"""Freqtrade framework adapter for vpvr_xs_pairs_30m_funding_filter_eth_sol_20260717.
...
NOT-PROFITABLE in-house). Both legs are native 30m parquets (no 15m
resample, unlike the BTC/SOL variant).
...
- Walk-forward OOS = 3 contiguous chronological folds (2023H1 / 2023H2 /
  ...
  walk_forward.json is unavailable.
...
try:
    ...
    class VPVRXsPairs30mETHSOLFreqtradeStrategy(IStrategy):
        """Freqtrade IStrategy wrapper for vpvr_xs_pairs_30m_funding_filter_eth_sol_20260717."""
...
def main() -> int:
    ...
    cv_record = {
        ...
        "notes": [
            ...
            "(sharpe 0.0265 / total_return -1.77% / max_dd -23.17%, 2588 trades).",
