"""Data loader for vpvr_micro_reversion_1h_funding_filter_20260710 (iter 70).

Resamples 1m canonical parquets to 1h bars. Writes a SHA256 manifest of the
...
Output layout (per-symbol 1h cache, this strategy owns it):
    <strategy_dir>/data/
