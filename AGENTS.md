...
- **Cost basis (locked by smark 2026-07-26)** — **maker 0.02% / taker 0.05% per side (Binance VIP0)**; pair-RT = maker 4bps / taker 10bps. All future validations use these tiers (NOT the old 4/24/60 backtrader/freqtrade tiers). se_h3 reference points under corrected full-notional replay: maker 4bps → Sharpe +5.98 (lives), **taker 10bps → −1.40 (dead)** — thin-margin stat-arb must be maker-executed to exist at all; taker execution of any <18bps-margin strategy is structurally dead. No maker pilot (human decision, SMA-36603).
